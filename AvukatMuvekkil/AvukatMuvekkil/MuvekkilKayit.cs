...
namespace AvukatMuvekkil
{
    public partial class MuvekkilKayit : Form
    {
        ...
        private void btnKayitOl_Click(object sender, EventArgs e)
        {
            ...
            string muvkey = txtAd.Text + rand.Next(0, 99999) + "Muv";

            string query = "Insert Into MuvekkilBilgileri (MuvekkilAdSoyad,MuvekkilSifre,MuvekkilEposta,MuvIP,MuvPort,MuvekkilKey) values (@ad,@sifre,@eposta,@muvip,@muvport,@muvkey)";
            ...
            cmd.Parameters.AddWithValue("@muvkey", muvkey);
